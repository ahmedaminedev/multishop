...
export const AdminPage: React.FC<AdminPageProps> = (props) => {
    ...
    return (
        <div className="flex h-screen bg-gray-100 dark:bg-gray-900 overflow-hidden">
            ...
            {/* Ajout de 'relative' ici pour contenir les en-têtes absolus des pages éditeurs */}
            <main className={`relative flex-1 flex flex-col min-w-0 ${isVisualEditor ? 'p-0 overflow-hidden' : 'p-8 overflow-y-auto'}`}>
                {renderActivePage()}
            </main>
        </div>
    );
