...
const PageLoader = () => (
    <div className="flex items-center justify-center min-h-[60vh] bg-gray-900">
        <div className="w-16 h-16 border-4 border-gray-800 border-t-neon-400 rounded-full animate-spin"></div>
    </div>
);
...
const AppContent: React.FC = () => {
    ...
    // Wrap navigation functions in block statements to ensure they return void, satisfying TS requirements for callback props.
    ...
    const renderPage = () => {
        ...
        return (
            <div className="flex flex-col min-h-screen w-full overflow-x-hidden transition-colors duration-300 bg-gray-100 dark:bg-gray-950 text-gray-800 dark:text-gray-100 font-sans">
                ...
                <ScrollToTopButton />
                {/* FIX: Remove incorrect and unused 'allProducts' prop from CartSidebar component call. */}
                <CartSidebar 
                    isLoggedIn={!!user} 
