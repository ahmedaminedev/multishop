...
const BACKEND_URL = (typeof import.meta !== 'undefined' && import.meta.env?.VITE_API_URL !== '/api' && import.meta.env?.VITE_API_URL) ? import.meta.env.VITE_API_URL : ''; 
const STORE_SLUG = (typeof import.meta !== 'undefined' && import.meta.env?.VITE_STORE_SLUG) || 'nutritionshop'; 
